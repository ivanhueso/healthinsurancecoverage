...
const PrivacyPolicy = () => (
  <Layout>
    ...
    <p>
      Your privacy is important to us. It is Get Best Offers' policy to respect
      your privacy regarding any information we may collect from you across our
      website, <Link to="/">https://www.getbestoffers.net</Link>, and other
    ...
    <p>This policy is effective as of 1 February 2019.</p>
  </Layout>
)
